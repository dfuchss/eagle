...
import edu.kit.ipd.eagle.impl.parse.execution.AgentExecution;
import edu.kit.ipd.eagle.impl.parse.prepipeline.IPrePipeline;
import edu.kit.ipd.eagle.impl.parse.prepipeline.PARSEPrePipeline;
import edu.kit.ipd.eagle.impl.parse.specification.hypothesis.OntologySelectorHypothesisSpec;
import edu.kit.ipd.eagle.impl.parse.specification.hypothesis.TopicExtractionHypothesisSpec;
import edu.kit.ipd.eagle.impl.parse.specification.hypothesis.WikiWSDHypothesisSpec;
