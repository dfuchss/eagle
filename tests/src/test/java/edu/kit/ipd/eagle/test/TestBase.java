...
public class TestBase {
    ...
    /**
     * Get all defined texts (from a former evaluation in the master thesis of Jan Keim).
     *
     * @return the texts
    ...
    // return OntologySelectorSpec.loadOntologies("src/test/resources/ontology-selector/", //
    // "kitchen.owl", "bedroom.owl", "bar.owl", "laundry.owl", "garden.owl", "childrens_room.owl", "heating.owl",
    // "music.owl");
    // }
