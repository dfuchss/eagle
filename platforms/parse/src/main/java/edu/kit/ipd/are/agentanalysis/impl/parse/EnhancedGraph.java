...
public final class EnhancedGraph {
	private final PARSEGraphWrapper graph;
	private final IPrePipeline<PARSEGraphWrapper> prepipeline;
	 ...
	 */
	public EnhancedGraph(String text, IPrePipeline<PARSEGraphWrapper> prepipeline) {
		this.text = text;
