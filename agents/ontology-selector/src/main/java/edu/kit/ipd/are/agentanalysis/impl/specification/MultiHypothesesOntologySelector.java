...
public class MultiHypothesesOntologySelector extends OntologySelector implements IHypothesesManager<PARSEGraphWrapper> {
	...
	protected String getMergedOntoIdentificator(List<OntologySelectionData> ontologies) {
	...
	private static class OntologyHypothesesSet extends BasicHypothesesSet {
		...
		public OntologyHypothesesSet(List<OntologySelectionData> ontologies, OntologyType type) {
